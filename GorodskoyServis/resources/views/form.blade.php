    ...
    <form method="POST" action="">
         ...
         <ul>
             <li>
                 ...
                 <input type="text" name="name" id="name" placeholder="Название заметки">
             </li>

             <li>
                 <label for="type">Название</label>
                 <select name="type" id="type" placeholder="Название заметки">
             ...
             <li>
                 ...
                 <textarea id="discription" name="discription" placeholder="Описание..."></textarea>
             </li>
